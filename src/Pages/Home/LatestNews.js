...
const LatestNews = () => {
    return (
        <div className='bg-[#f5f5f5]'>
            <div className=' pb-24 mx-auto max-w-7xl'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-12 lg:gap-0 justify-items-center mx-auto lg:px-20 px-6 pt-8  '>
