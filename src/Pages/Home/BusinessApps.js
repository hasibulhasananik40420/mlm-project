...
const BusinessApps = () => {
    return (
        <div className="bg-[url('https://corporx.themetags.com/assets/img/hero-bg11.jpg')] object-cover ">
            <div className='lg:h-[100vh] opacity-80 bg-gradient-to-r from-[#1A2C79] to-[#e80566]'>
                ...
                <div className='text-center lg:p-24 p-8'>
                    ...
                    <p className='text-xl font-medium font-Poppins text-white mt-8'>Building your Apps helps attract more potential clients. Our integrated marketing team</p>
                    <p className='text-xl font-medium font-Poppins text-white mt-1'>will promote enabled internal or work high-impact convergence.</p>
