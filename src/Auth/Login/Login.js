                ...
                <div className="flex flex-col bg-white shadow-2xl px-4 sm:px-6 md:px-8 lg:px-10 py-8 rounded-md w-full max-w-md">
                    ...
                    <div className="mt-10">
                        <form action="#">
                            ...
                            <div className="flex w-full">
                                <button type="submit" className="flex items-center justify-center focus:outline-none text-white text-sm sm:text-base bg-[#e80566] rounded py-2 w-full transition duration-150 ease-in">
                    ...
                    <div className="flex justify-center items-center mt-6">
                        <a href="" target="_blank" className="inline-flex items-center font-bold text-blue-500 hover:text-blue-700 text-xs text-center">
                            ...
                            <Link to='/register'> <span className="ml-2">You don't have an account?</span></Link>
                        </a>
                    </div>
                </div>
            </div>
